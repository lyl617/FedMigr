...
model_type='CNN'
checkpoint_dir='./Checkpoint/Checkpoint_MIGR_data_pattern_0_FashionMNIST/'
enable_lr_decay=1
epochs=2000
epoch_step=100
...
aggregate_interval=20
log_interval=100
pattern_idx=1 # 0-bias, 2-random
dataset_type='CIFAR10' #lr 0.01-0.001
model_type='CNN'
checkpoint_dir='./Checkpoint/Checkpoint_MIGR_data_pattern_1_CIFAR10/'
enable_lr_decay=1
epochs=2000
epoch_step=100
epoch_start_idxs=(0 100 200 300 400 500 600 700 800 900 1000 1100 1200 1300 1400 1500 1600 1700 1800 1900)
...
log_interval=100
pattern_idx=0 # 0-bias, 2-random
dataset_type='CIFAR100' #lr 0.01-0.001
model_type='CNN'
checkpoint_dir='./Checkpoint/Checkpoint_MIGR_data_pattern_0_CIFAR100/'
enable_lr_decay=1
epochs=2000
epoch_step=100
epoch_start_idxs=(0 100 200 300 400 500 600 700 800 900 1000 1100 1200 1300 1400 1500 1600 1700 1800 1900)
...
model_type='LR'
checkpoint_dir='./Checkpoint/Checkpoint_MIGR_data_pattern_1_MNIST/'
enable_lr_decay=1
aggregate_interval=20
epochs=2000
epoch_step=100
...
do
    ...
    if [ $enable_lr_decay -eq 1 ]; then
        python fl_model_random_migration_gpu_sh.py --epochs $epochs --epoch_start $epoch_start --epoch_step $epoch_step \
                                                      ...
                                                      --pattern_idx $pattern_idx --checkpoint_dir $checkpoint_dir --seed $RANDOM --visible_cuda $visible_cuda \
                                                      --no_cuda --save_model --train_flag --enable_lr_decay 
    else
        python fl_model_random_migration_gpu_sh.py --epochs $epochs --epoch_start $epoch_start --epoch_step $epoch_step \
                                                      --batch_size $batch_size --lr $lr --min_lr $min_lr --vm_num $vm_num --local_iters $local_iters \
                                                      --aggregate_interval $aggregate_interval --log_interval $log_interval --dataset_type $dataset_type --model_type $model_type \
                                                      --pattern_idx $pattern_idx --checkpoint_dir $checkpoint_dir --seed $RANDOM --visible_cuda $visible_cuda \
                                                      --no_cuda --save_model --train_flag
